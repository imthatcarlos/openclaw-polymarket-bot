 ...
 */
export function binaryOptionFairValue(currentPrice, strikePrice, timeRemainingSeconds, annualizedVol) {
 ...
 */
export function estimateVolatility(prices, intervalSeconds = 60) {
    if (prices.length < 3)
        return 0.50; // Default 50% annual vol for BTC
